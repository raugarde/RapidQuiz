 ...
 */
@WebServlet(name = "ResultList", urlPatterns = { "/ctl/ResultList" })
public class ResultList extends BaseCtl{
	private static final long serialVersionUID = 1L;
	
	private static Logger log = Logger.getLogger(ResultList.class);
