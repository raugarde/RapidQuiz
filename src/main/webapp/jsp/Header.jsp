            ...
            <div class="main_menu">
				...
				<%if(userDto.getRole_Id()==1){ %>
								...
								<li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Admin Options</a>
									<ul class="dropdown-menu">
										...
										<li class="nav-item"><a class="nav-link" href="<%=ORSView.RESULT_LIST%>">Show Results</a></li>
									</ul>
								</li> 
