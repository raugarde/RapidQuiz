<%@page import="in.com.online.exam.controller.StartExamCtl"%>
...
<h2 style="color: white; font-style:normal;">Start Exam</h2></div>
<br>
<div class="container">
    <h1 class="well">Start Exam</h1>
   <b><font class="text-center" color="red"><%=ServletUtility.getErrorMessage(request)%></font></b>
	...
	<div class="row">
				<form action="<%=ORSView.STARTEXAM_CTL%>"  method="post" >
